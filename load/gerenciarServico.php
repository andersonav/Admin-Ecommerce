<input type="hidden" id="pagina_atual" value="gerenciarServico">
<div class="row">
    <div class="col-md-12">
        <div class="card">
        ...
        <form class="col s12"  id="formulario" method="post" enctype="multipart/form-data">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Editar Serviços</h5>
                ...
                <div class="modal-body">
                    ...
                    <input type="hidden" name="action" value="editar-servico">
...
<script src="load/js/gerenciarServico.js"></script>
