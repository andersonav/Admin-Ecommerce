...
<body class="">
    <div class="wrapper ">
        <div class="sidebar" data-color="danger" data-background-color="white" data-image="assets/img/sidebar-3.jpg">
            ...
            <div class="logo">
                <a href="#!" class="simple-text logo-normal">
                    <img src="assets/img/lindoPet.png" width="100" />
                </a>
            </div>
            <?php
            include './sibebar.php';
        ...
        <div class="main-panel">
            ...
            <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
                <div class="container-fluid">
                    ...
                    <div class="navbar-wrapper">
                        <a class="navbar-brand" href="javascript:void(0);">Seja Bem Vindo, <?php echo $_SESSION['login']; ?></a>
                    </div>
                        ...
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownProfile">
                                    ...
                                    <!--<a class="dropdown-item" href="#">Configu</a>-->
            ...
            <!-- End Navbar -->
            <div class="content">
                <div class="container-fluid" id="containerLoadInformations">
            ...
            <footer class="footer">
                <div class="container-fluid">
                    ...
                    <div class="copyright center">
                        ...
                        <a href="javascript:void(0);">RedTag</a>.
                    </div>
                </div>
            </footer>
        </div>
